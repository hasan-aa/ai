...
function experimental_useAssistant({
  ...
  const submitMessage = async (event, requestOptions) => {
    ...
    setInput("");
    return callApi(void 0, void 0, requestOptions == null ? void 0 : requestOptions.data);
  };
  const callApi = async (_threadId, action, data) => {
    var _a, _b;
    const result = await fetch(api, {
      ...
      body: JSON.stringify({
        ...
        threadId: (_b = (_a = _threadId != null ? _threadId : threadIdParam) != null ? _a : threadId) != null ? _b : null,
        message: input,
  ...
  const loadThread = async (threadId2 = threadIdParam) => {
